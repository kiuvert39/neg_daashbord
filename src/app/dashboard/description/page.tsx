...
const Description = ({ searchParams }: any) => {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.top}>
        ...
        <Link href="/dashboard/description/add">
          <button className={styles.addButton}>Add New Description</button>
        </Link>
      </div>
            ...
            <tr key={post.id}>
              ...
              <td>
                <div className={styles.buttons}>
                  <Link href={`/dashboard/decription/${post.id}`}>
